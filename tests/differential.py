...
BATCHES = [
    ...
    # ---- sintercard / hrandfield / lcs (appended batches)
    [(b"FLUSHALL",), (b"SADD", b"a", b"1", b"2", b"3", b"4"), (b"SADD", b"b", b"2", b"3", b"5"),
     (b"SINTERCARD", b"2", b"a", b"b"), (b"SINTERCARD", b"2", b"a", b"b", b"LIMIT", b"1"),
     (b"SINTERCARD", b"2", b"a", b"b", b"LIMIT", b"0"), (b"SINTERCARD", b"2", b"a", b"nok"),
     (b"SINTERCARD", b"1", b"a"), (b"SINTERCARD", b"2", b"a", b"a"),
     (b"SINTERCARD", b"0", b"a"), (b"SINTERCARD", b"3", b"a", b"b"),
     (b"SINTERCARD", b"2", b"a", b"b", b"LIMIT", b"-1"), (b"SINTERCARD", b"2", b"a", b"b", b"LIMIT", b"x"),
     (b"SINTERCARD", b"2", b"a", b"b", b"BOGUS"), (b"SINTERCARD", b"2", b"a", b"b", b"LIMIT"),
     (b"SET", b"str", b"x"), (b"SINTERCARD", b"2", b"a", b"str"),
     (b"HSET", b"h", b"a", b"1", b"b", b"2", b"c", b"3"),
     (b"HRANDFIELD", b"h", b"0"), (b"HRANDFIELD", b"h", b"9"), (b"HRANDFIELD", b"h", b"9", b"WITHVALUES"),
     (b"HRANDFIELD", b"noh"), (b"HRANDFIELD", b"noh", b"2"), (b"HRANDFIELD", b"noh", b"2", b"WITHVALUES"),
     (b"HRANDFIELD", b"h", b"2", b"BOGUS"), (b"HRANDFIELD", b"h", b"WITHVALUES"),
     (b"HRANDFIELD", b"h", b"0", b"WITHVALUES"), (b"HRANDFIELD", b"str", b"2"),
     (b"SET", b"l1", b"ohmytext"), (b"SET", b"l2", b"mynewtext"),
     (b"LCS", b"l1", b"l2"), (b"LCS", b"l1", b"l2", b"LEN"),
     (b"LCS", b"l1", b"l2", b"IDX"), (b"LCS", b"l1", b"l2", b"IDX", b"WITHMATCHLEN"),
     (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN", b"3"), (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN", b"1"),
     (b"LCS", b"l1", b"l2", b"MINMATCHLEN", b"2"), (b"LCS", b"l1", b"l2", b"WITHMATCHLEN"),
     (b"LCS", b"l1", b"l2", b"LEN", b"IDX"), (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN", b"0"),
     (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN", b"-3"), (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN", b"x"),
     (b"LCS", b"l1", b"l2", b"BOGUS"), (b"LCS", b"l1", b"l2", b"IDX", b"MINMATCHLEN"),
     (b"LCS", b"l1", b"nok"), (b"LCS", b"nok", b"l2", b"LEN"), (b"LCS", b"nok", b"nok2", b"IDX"),
     (b"SET", b"e", b""), (b"LCS", b"e", b"l2"), (b"LCS", b"e", b"l2", b"LEN"),
     (b"SET", b"same", b"abc"), (b"LCS", b"same", b"same"), (b"LCS", b"same", b"same", b"IDX"),
     (b"SET", b"u1", b"ab"), (b"SET", b"u2", b"ba"),
     (b"LCS", b"u1", b"u2"), (b"LCS", b"u1", b"u2", b"IDX"),
     (b"SET", b"u3", b"banana"), (b"SET", b"u4", b"atana"),
     (b"LCS", b"u3", b"u4"), (b"LCS", b"u3", b"u4", b"IDX"),
     (b"SET", b"u5", b"abcabc"), (b"SET", b"u6", b"acbacb"),
     (b"LCS", b"u5", b"u6"), (b"LCS", b"u5", b"u6", b"IDX"),
     (b"SET", b"u7", b"aaaaaaaa"), (b"SET", b"u8", b"aaaa"), (b"LCS", b"u7", b"u8", b"IDX"),
     (b"SET", b"u9", b"xyz"), (b"SET", b"u10", b"abc"),
     (b"LCS", b"u9", b"u10", b"IDX"), (b"LCS", b"u9", b"u10", b"LEN"),
     (b"SET", b"big1", b"The quick brown fox jumps over the lazy dog"),
     (b"SET", b"big2", b"The slow brown cat jumps beside the lazy dog"),
     (b"LCS", b"big1", b"big2"),
     (b"RPUSH", b"lst", b"x"), (b"LCS", b"l1", b"lst")],
    # ---- bitfield (bitmap keys only: kagni splits strings from bitmaps)
    [(b"FLUSHALL",), (b"BITFIELD", b"nok", b"GET", b"u8", b"0"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"0", b"255"), (b"BITFIELD", b"k", b"GET", b"u8", b"0"),
     (b"BITFIELD", b"k", b"GET", b"u4", b"0"), (b"BITFIELD", b"k", b"GET", b"u4", b"4"),
     (b"BITFIELD", b"k", b"GET", b"i8", b"0"),
     (b"BITFIELD", b"k", b"SET", b"i8", b"8", b"-1"), (b"BITFIELD", b"k", b"GET", b"i8", b"8"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"#2", b"7"), (b"BITFIELD", b"k", b"GET", b"u8", b"16"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"21", b"255"), (b"BITFIELD", b"k", b"GET", b"u16", b"16"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"40", b"300"), (b"BITFIELD", b"k", b"GET", b"u8", b"40"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"48", b"-1"), (b"BITFIELD", b"k", b"GET", b"u8", b"48"),
     (b"BITFIELD", b"k", b"SET", b"i8", b"56", b"-200"), (b"BITFIELD", b"k", b"GET", b"i8", b"56"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"WRAP", b"INCRBY", b"u8", b"0", b"1"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"SAT", b"INCRBY", b"u8", b"0", b"1"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"FAIL", b"INCRBY", b"u8", b"0", b"1"),
     (b"BITFIELD", b"k", b"GET", b"u8", b"0"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"SAT", b"INCRBY", b"i8", b"8", b"-300"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"SAT", b"SET", b"u8", b"64", b"300"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"FAIL", b"SET", b"u8", b"72", b"300"),
     (b"BITFIELD", b"k", b"GET", b"u8", b"72"),
     (b"BITFIELD", b"new", b"INCRBY", b"u8", b"0", b"5"), (b"BITFIELD", b"new", b"GET", b"u8", b"0"),
     (b"BITFIELD", b"new", b"INCRBY", b"i8", b"0", b"-5"), (b"BITFIELD", b"new", b"GET", b"i8", b"0"),
     (b"BITFIELD", b"new", b"INCRBY", b"u8", b"0", b"-10"), (b"BITFIELD", b"new", b"GET", b"u8", b"0"),
     (b"BITFIELD", b"k", b"GET", b"u64", b"0"), (b"BITFIELD", b"k", b"GET", b"i64", b"0"),
     (b"BITFIELD", b"k", b"GET", b"u65", b"0"), (b"BITFIELD", b"k", b"GET", b"i0", b"0"),
     (b"BITFIELD", b"k", b"GET", b"u-1", b"0"), (b"BITFIELD", b"k", b"GET", b"x8", b"0"),
     (b"BITFIELD", b"k", b"GET", b"u8", b"-1"), (b"BITFIELD", b"k", b"GET", b"u8", b"x"),
     (b"BITFIELD", b"k", b"SET", b"u1", b"5000000000", b"1"),
     (b"BITFIELD", b"k", b"OVERFLOW", b"BOGUS"), (b"BITFIELD", b"k", b"BOGUS"),
     (b"BITFIELD", b"k", b"SET", b"u8"), (b"BITFIELD", b"k"),
     (b"BITFIELD", b"k", b"SET", b"u8", b"0", b"1", b"SET", b"u8", b"8", b"2",
      b"GET", b"u8", b"0", b"GET", b"u8", b"8"),
     (b"BITFIELD_RO", b"k", b"GET", b"u8", b"0"), (b"BITFIELD_RO", b"nok", b"GET", b"u8", b"0"),
     (b"BITFIELD_RO", b"k", b"SET", b"u8", b"0", b"1"),
     (b"BITFIELD_RO", b"k", b"INCRBY", b"u8", b"0", b"1"),
     (b"BITFIELD_RO", b"k", b"OVERFLOW", b"WRAP", b"GET", b"u8", b"0")],

    # ---- hash field expiries (time-value replies use far deadlines;
    # ttl-row replies right after setting are deterministic enough)
    [(b"FLUSHALL",), (b"HSET", b"h", b"f", b"v", b"g", b"w", b"n", b"5"),
     (b"HEXPIRE", b"h", b"100", b"FIELDS", b"2", b"f", b"g"),
     (b"HTTL", b"h", b"FIELDS", b"2", b"f", b"g"), (b"HPTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HPERSIST", b"h", b"FIELDS", b"2", b"f", b"g"), (b"HTTL", b"h", b"FIELDS", b"2", b"f", b"g"),
     (b"HPERSIST", b"h", b"FIELDS", b"1", b"f"),
     (b"HTTL", b"h", b"FIELDS", b"1", b"nope"), (b"HTTL", b"noh", b"FIELDS", b"1", b"f"),
     (b"HPTTL", b"noh", b"FIELDS", b"1", b"f"), (b"HEXPIRETIME", b"noh", b"FIELDS", b"1", b"f"),
     (b"HPERSIST", b"noh", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"noh", b"5", b"FIELDS", b"1", b"x"),
     (b"HEXPIRE", b"h", b"50", b"FIELDS", b"1", b"f"), (b"HPTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"NX", b"50", b"FIELDS", b"1", b"f"), (b"HTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"NX", b"50", b"FIELDS", b"1", b"n"), (b"HTTL", b"h", b"FIELDS", b"1", b"n"),
     (b"HEXPIRE", b"h", b"XX", b"200", b"FIELDS", b"1", b"f"), (b"HTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"XX", b"200", b"FIELDS", b"1", b"g"), (b"HTTL", b"h", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"GT", b"300", b"FIELDS", b"1", b"f"), (b"HTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"GT", b"10", b"FIELDS", b"1", b"f"), (b"HTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"GT", b"5", b"FIELDS", b"1", b"g"), (b"HTTL", b"h", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"LT", b"10", b"FIELDS", b"1", b"f"), (b"HTTL", b"h", b"FIELDS", b"1", b"f"),
     (b"HEXPIRE", b"h", b"LT", b"5", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"FIELDS", b"1", b"absent"),
     (b"HEXPIRE", b"h", b"GT", b"5", b"FIELDS", b"1", b"absent"),
     (b"HEXPIRE", b"h", b"XX", b"5", b"FIELDS", b"1", b"absent"),
     (b"HEXPIREAT", b"h", b"9999999999", b"FIELDS", b"1", b"g"),
     (b"HEXPIRETIME", b"h", b"FIELDS", b"1", b"g"),
     (b"HEXPIREAT", b"h", b"1", b"FIELDS", b"1", b"g"), (b"HEXISTS", b"h", b"g"),
     (b"HPEXPIRE", b"h", b"100000", b"FIELDS", b"1", b"n"), (b"HPTTL", b"h", b"FIELDS", b"1", b"n"),
     (b"HPEXPIRE", b"h", b"0", b"FIELDS", b"1", b"n"), (b"HEXISTS", b"h", b"n"),
     (b"HPEXPIREAT", b"h", b"1", b"FIELDS", b"1", b"f"),
     (b"HSET", b"h", b"g", b"w2"), (b"HTTL", b"h", b"FIELDS", b"1", b"g"),
     (b"HSET", b"h2", b"num", b"1"), (b"HEXPIRE", b"h2", b"100", b"FIELDS", b"1", b"num"),
     (b"HINCRBY", b"h2", b"num", b"1"), (b"HTTL", b"h2", b"FIELDS", b"1", b"num"),
     (b"HINCRBYFLOAT", b"h2", b"num", b"0.5"), (b"HTTL", b"h2", b"FIELDS", b"1", b"num"),
     (b"HSET", b"h2", b"num", b"9"), (b"HTTL", b"h2", b"FIELDS", b"1", b"num"),
     (b"HGETALL", b"h2"),
     (b"HEXPIRE", b"h", b"-1", b"FIELDS", b"1", b"g"), (b"HEXPIRE", b"h", b"0", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"x", b"FIELDS", b"1", b"g"), (b"HEXPIRE", b"h", b"1", b"FIELDS", b"x", b"g"),
     (b"HEXPIRE", b"h", b"1", b"FIELDS", b"0"), (b"HEXPIRE", b"h", b"1", b"FIELDS", b"2", b"g"),
     (b"HEXPIRE", b"h", b"1", b"FIELDS"), (b"HEXPIRE", b"h", b"1"),
     (b"HEXPIRE", b"h", b"5", b"NX", b"XX", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"GT", b"LT", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"NX", b"NX", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"NX", b"GT", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"XX", b"GT", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"BOGUS", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"5", b"FIELDS", b"1", b"g", b"extra"),
     (b"HEXPIRE", b"h", b"10000000000", b"FIELDS", b"1", b"g"),
     (b"HEXPIRE", b"h", b"100000000000", b"FIELDS", b"1", b"g"),
     (b"HEXPIREAT", b"h", b"70368744177663", b"FIELDS", b"1", b"g"),
     (b"HEXPIREAT", b"h", b"70368744177664", b"FIELDS", b"1", b"g"),
     (b"HPEXPIREAT", b"h", b"70368744177663", b"FIELDS", b"1", b"g"),
     (b"HPEXPIREAT", b"h", b"70368744177664", b"FIELDS", b"1", b"g"),
     (b"HPEXPIRE", b"h", b"70368744177663", b"FIELDS", b"1", b"g"),
     (b"SET", b"str", b"x"), (b"HEXPIRE", b"str", b"5", b"FIELDS", b"1", b"f"),
     (b"HTTL", b"str", b"FIELDS", b"1", b"f"),
     (b"HTTL", b"h", b"FIELDS"), (b"HTTL", b"h", b"FIELDS", b"0"),
     (b"HTTL", b"h", b"FIELDS", b"x", b"g"), (b"HTTL", b"h", b"FIELDS", b"-1", b"g"),
     (b"HTTL", b"h", b"FIELDS", b"2", b"g"), (b"HTTL", b"h", b"FIELDS", b"1", b"g", b"extra"),
     (b"HTTL", b"h"), (b"HEXPIRETIME", b"h", b"FIELDS", b"1", b"g")],
